...
class SpendingsControllerTest < ActionController::TestCase
  ...
  test "should create spending" do
    assert_difference('Spending.count') do
      post :create, spending: { date: @spending.date, descrption: @spending.descrption, name: @spending.name, planned: @spending.planned }
    end
  ...
  test "should update spending" do
    patch :update, id: @spending, spending: { date: @spending.date, descrption: @spending.descrption, name: @spending.name, planned: @spending.planned }
    assert_redirected_to spending_path(assigns(:spending))
  end
